      ...
      <Body>
          ...
          <Box
            ...
            <Box flexDirection="row" alignItems="center" gap={5}>
              ...
              <Text
                ...
                numberOfLines={2}
                w={moderateScale(260)}>
                To make a withdrawal, you must complete { kycVarification?.varification!=="Approve"?"KYC verification":"Bank verification"}.
              </Text>
            </Box>
            <PrimaryButton
              textColor="white"
          ...
          {boxes.map((item, index) => (
            <Pressable key={index} onPress={() => setSelectedBox(index)}>
              <Box
                ...
                padding={24}
                width={180}
                borderColor={selectedBox === index ? colors.gold : 'white'}
                margin={5}>
        ...
        <Box
          ...
          <Box>
            ...
            {/* <Box flexDirection='row' alignItems='center' borderBottomWidth={1} borderBlockColor={colors.gray3} gap={10} px={moderateScale(10)} py={moderateScaleVertical(10)}>
              <Box>
                <Text fontFamily={'$robotoBold'} fontSize={12} lineHeight={14} color={colors.black} numberOfLines={1} >Instant</Text>
                <Text fontFamily={'$robotoBold'} fontSize={12} lineHeight={14} color={colors.black} numberOfLines={1} >Withdrawals :</Text>
              </Box>

              <Box>
                <Text fontFamily={'$robotoMedium'} fontSize={10} lineHeight={12} color={colors.black} numberOfLines={1} >Daily</Text>
                <Text fontFamily={'$robotoBold'} fontSize={14} lineHeight={16} color={colors.black} numberOfLines={1} w={moderateScale(80)}>0 / 100</Text>
              </Box>

              <Box borderRightWidth={1} borderRightColor={colors.gray3} h={moderateScale(20)}></Box>

              <Box>
                <Text fontFamily={'$robotoMedium'} fontSize={10} lineHeight={12} color={colors.black} numberOfLines={1} >Special</Text>
                <Text fontFamily={'$robotoBold'} fontSize={14} lineHeight={16} color={colors.black} numberOfLines={1} w={moderateScale(80)}>0</Text>
              </Box>
            </Box> */}
          </Box>
          ...
          <Box
            ...
            <Input
              ...
              <InputSlot pr="$3">
                <InputIcon as={RupeeCircleIcon} />
              </InputSlot>
              <InputField
                color={colors.gold}
                fontFamily="$robotoMedium"
                fontSize={14}
                onChangeText={t => setEnterWithdrawAmount(Number(t))}
            ...
            {selectedBox == 2 ? (
              <>
                <Text
                  ...
                  color={colors.white}
                  numberOfLines={1}>
                  Withdrawal Amount to be greater than {'\u20B9'} {minimumWidthraw}
                </Text>
              </>
            ) : null}
          </Box>
